...
public class LinearRegression_GradientDescent_Aimo {
    // 数据成员
    ...
    public void buildClassifier(Instances train) throws Exception {
        ...
        // 求解最优参数
        Matrix theta = new Matrix(Num_Attributes, 1);
        for (int i = 0; i < Num_Attributes; i++) {
            theta.set(i, 0, 0.0);
        }
        Matrix thetas = Gradient_Descent(0.01, Matrix_X, Matrix_Y, 0.0000001, 100000);
